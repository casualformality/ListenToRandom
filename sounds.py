...
# 
# This version uses pygame to play the sounds (more efficient)
# 

import sys, pygame, _thread, time, random, os, threading, scipy
import pygame.mixer
...
def play_sounds(dirname, freq):
    ...
    sounds = []
    for f in files:
        sound = pygame.mixer.Sound(join(dirname, f))
